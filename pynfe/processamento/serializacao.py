...
class SerializacaoXML(Serializacao):
            ...
            if int(pagamento.tipo_pagamento) == 3 or int(pagamento.tipo_pagamento) == 4:
                ...
                if int(pagamento.integracao_pagamento) == 2:
                    ...
                    if so_numeros(pagamento.cnpj_credenciadora_cartao):
                        etree.SubElement(cartao, 'CNPJ').text = so_numeros(pagamento.cnpj_credenciadora_cartao)
    ...
    def _serializar_nota_fiscal(
        ...
        if nota_fiscal.troco:
            etree.SubElement(pag, 'vTroco').text = "{:.2f}".format(
                nota_fiscal.troco
            )
...
class SerializacaoQrcode(object):
    ...
    def gerar_qrcode(self, token, csc, xml, return_qr=False, online=True):
        ...
        lista_uf_padrao = ["PR", "CE", "RS", "RJ", "RO", "DF", "MS", "MT", "MG"]
