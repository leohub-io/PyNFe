...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def preenche_notafiscal_produto_cst41(self):
        ...
        self.notafiscal.adicionar_pagamento(t_pag="01", x_pag="Dinheiro", v_pag=107.00, ind_pag=0)
    ...
    def total_e_produto_cst41_test(self):
        ...
        orig = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS40/ns:orig", namespaces=self.ns
        )[0].text
        CST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS40/ns:CST", namespaces=self.ns
        )[0].text
        vICMSDeson = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS40/ns:vICMSDeson", namespaces=self.ns
        )[0].text
        motDesICMS = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS40/ns:motDesICMS", namespaces=self.ns
        )[0].text
