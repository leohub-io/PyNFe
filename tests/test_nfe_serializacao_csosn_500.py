...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def preenche_notafiscal_produto_csosn500(self):
    ...
    def total_e_produto_csosn500_test(self):
        # Produto
        ...
        orig = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN500/ns:orig", namespaces=self.ns
        )[0].text
        CSOSN = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN500/ns:CSOSN", namespaces=self.ns
        )[0].text

        self.assertEqual(orig, "0")
        self.assertEqual(CSOSN, "500")
    ...
    def test_notafiscal_produto_csosn400(self):
        ...
        self.total_e_produto_csosn500_test()
