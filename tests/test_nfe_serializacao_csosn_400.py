...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def preenche_notafiscal_produto_csosn400(self):
    ...
    def total_e_produto_csosn400_test(self):
        ...
        self.assertEqual(CSOSN, "400")

        # CSOSN 400 gera a tag 102
        CSOSN400 = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN400/ns:CSOSN", namespaces=self.ns
        )
        self.assertEqual(CSOSN400, [])
    ...
    def test_notafiscal_produto_csosn400(self):
        ...
        self.notafiscal = self.preenche_notafiscal_produto_csosn400()
        ...
        self.total_e_produto_csosn400_test()
