...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_cst60_test(self):
        ...
        orig = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS60/ns:orig", namespaces=self.ns
        )[0].text
        CST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS60/ns:CST", namespaces=self.ns
        )[0].text
        vBCSTRet = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS60/ns:vBCSTRet", namespaces=self.ns
        )[0].text
        pST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS60/ns:pST", namespaces=self.ns
        )[0].text
        vICMSSTRet = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS60/ns:vICMSSTRet", namespaces=self.ns
        )[0].text
