...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def sem_grupo_destinatario_test(self):
        expected = []
        tag_dest = self.xml_assinado.xpath("//ns:dest", namespaces=self.ns)
        self.assertEqual(tag_dest, expected)
    ...
    def test_notafiscal_produto_cst00(self):
        ...
        self.sem_grupo_destinatario_test()
