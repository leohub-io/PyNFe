...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_cst70_test(self):
        ...
        orig = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:orig", namespaces=self.ns
        )[0].text
        CST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:CST", namespaces=self.ns
        )[0].text
        modBC = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:modBC", namespaces=self.ns
        )[0].text
        pRedBC = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:pRedBC", namespaces=self.ns
        )[0].text
        vBC = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vBC", namespaces=self.ns
        )[0].text
        pICMS = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:pICMS", namespaces=self.ns
        )[0].text
        vICMS = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vICMS", namespaces=self.ns
        )[0].text
        vBCFCP = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vBCFCP", namespaces=self.ns
        )[0].text
        pFCP = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:pFCP", namespaces=self.ns
        )[0].text
        vFCP = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vFCP", namespaces=self.ns
        )[0].text

        modBCST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:modBCST", namespaces=self.ns
        )[0].text
        pMVAST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:pMVAST", namespaces=self.ns
        )[0].text
        pRedBCST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:pRedBCST", namespaces=self.ns
        )[0].text
        vBCST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vBCST", namespaces=self.ns
        )[0].text
        pICMSST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:pICMSST", namespaces=self.ns
        )[0].text
        vICMSST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vICMSST", namespaces=self.ns
        )[0].text
        vBCFCPST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vBCFCPST", namespaces=self.ns
        )[0].text
        pFCPST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:pFCPST", namespaces=self.ns
        )[0].text
        vFCPST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS70/ns:vFCPST", namespaces=self.ns
        )[0].text
