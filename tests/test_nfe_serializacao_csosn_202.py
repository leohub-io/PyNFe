...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def preenche_notafiscal_produto_csosn202(self):
    ...
    def total_e_produto_csosn202_test(self):
        # Produto
    ...
    def test_notafiscal_produto_csosn202(self):
        ...
        self.total_e_produto_csosn202_test()
