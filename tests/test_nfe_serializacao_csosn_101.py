...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_csosn101_test(self):
        ...
        orig = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN101/ns:orig", namespaces=self.ns
        )[0].text
        CSOSN = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN101/ns:CSOSN", namespaces=self.ns
        )[0].text
        pCredSN = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMSSN101/ns:pCredSN", namespaces=self.ns
        )[0].text
