...
class SerializacaoNFeTestCase(unittest.TestCase):
    ...
    def total_e_produto_cst51_test(self):
        ...
        orig = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS51/ns:orig", namespaces=self.ns
        )[0].text
        CST = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS51/ns:CST", namespaces=self.ns
        )[0].text
        modBC = self.xml_assinado.xpath(
            "//ns:det/ns:imposto/ns:ICMS/ns:ICMS51/ns:modBC", namespaces=self.ns
        )[0].text
